...
(function ($, document, window, undefined) {
  ...
  $.fn.pagepiling = function (custom) {
    ...
    PP.moveSectionUp = function () {
      var prev = $(".pp-section.active").prev(
        ".pp-section",
      );
    ...
    PP.moveSectionDown = function () {
      var next = $(".pp-section.active").next(
        ".pp-section",
      );
    ...
    $(container).css({
      overflow: "hidden",
      "-ms-touch-action":
        "none" /* Touch detection for Windows 8 */,
      "touch-action":
        "none" /* IE 11 on Windows Phone 8.1*/,
    });
    ...
    $(".pp-section")
      .each(function (index) {
        ...
        if (
          typeof options.sectionsColor[index] !==
          "undefined"
        ) {
          $(this).css(
            "background-color",
      ...
      .done(function () {
        ...
        if (options.navigation) {
          ...
          $("#pp-nav")
            .find("li")
            .eq(
              $(".pp-section.active").index(".pp-section"),
            )
            .find("a")
            .addClass("active");
        }
    ...
    function getYmovement(destiny) {
      var fromIndex = $(".pp-section.active").index(
        ".pp-section",
      );
      ...
      if (v.yMovement === "down") {
        ...
        if (!options.css3) {
          v.sectionsToMove.each(function (index) {
            if (
              index != v.activeSection.index(".pp-section")
            ) {
    ...
    function getSectionsToMove(v) {
      ...
      if (v.yMovement === "down") {
        sectionToMove = $(".pp-section").map(function (
          index,
        ) {
    ...
    function removeMouseWheelHandler() {
      if (container.get(0).addEventListener) {
        ...
        container
          .get(0)
          .detachEvent("onmousewheel", MouseWheelHandler); //IE 6/7/8
      }
    }
    ...
    function checkParentForNormalScrollElement(el, hop) {
      ...
      if (
        ...
        return checkParentForNormalScrollElement(
          parent,
          ++hop,
        );
      }
